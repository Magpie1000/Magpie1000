...
Software engineering felt like the intersection of the best parts of both careers.

| Previous Experience        | What I Enjoyed                                                                | How It Connected to Software Engineering                                             |
| -------------------------- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| **Education**              | Explaining complex ideas, helping people learn, organizing learning materials | Technical communication, documentation, mentoring, and building tools for users      |
| **Hospitality / Cooking**  | Fast-paced teamwork, pressure, precision, and constant process improvement    | Team-based delivery, debugging under constraints, iteration, and production mindset  |
| **Self-built Excel tools (in Education Field)** | Turning messy exam materials into a searchable, reusable system               | Automation, data organization, workflow improvement, and practical software thinking |

At the time, I had no formal software engineering experience. But the pattern was clear: **I enjoyed structured thinking, useful systems, continuous learning, and collaborative problem solving.**

**Software engineering became the right next step in my career.** 

### Earning the Opportunity Through Assessments, Interviews, and Presentation
So, I applied to several software academies throughout Korea, including SSAFY.

Given SSAFY’s highly competitive application process and low acceptance rate, I did not have very high hopes of getting accepted. I still had 0 formal software engineering work experience.

However, SSAFY used a holistic application process. The application process included:

1. Tests measuring computational thinking, learning ability, and problem-solving potential
